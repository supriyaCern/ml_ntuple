...
cmsDriver.py step2  -s DIGI:pdigi_valid,L1TrackTrigger,L1,DIGI2RAW,HLT:@fake2 --conditions auto:phase2_realistic_T21 --datatier GEN-SIM-DIGI-RAW -n 320 --eventcontent FEVTDEBUGHLT --geometry Extended2026D86 --era Phase2C17I13M9 --pileup AVE_150_BX_25ns --pileup_input root://eosuser.cern.ch//eos/user/p/psuryade/ml_ntuples/PU_14_1/step1_${index}.root --filein  file:step1_${index}.root  --fileout file:step2_${index}.root --nThreads 4
