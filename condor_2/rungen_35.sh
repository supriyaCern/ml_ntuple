...
cmsDriver.py SingleElectronPt100_hgcal_cfi -s GEN,SIM -n 1000 --conditions auto:phase2_realistic_T21 --beamspot HGCALCloseBy --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry Extended2026D86 --era Phase2C11I13M9 --relval 9000,100 --fileout file:step1_${index}.root  --customise_commands process.RandomNumberGeneratorService.generator.initialSeed="cms.untracked.uint32($RANDOM)" --no_exec  --nThreads 4
...
cmsDriver.py step2  -s DIGI:pdigi_valid,L1TrackTrigger,L1,DIGI2RAW,HLT:@fake2 --conditions auto:phase2_realistic_T21 --datatier GEN-SIM-DIGI-RAW -n 1000 --eventcontent FEVTDEBUGHLT --geometry Extended2026D86 --era Phase2C17I13M9 --pileup AVE_35_BX_25ns --pileup_input root://eosuser.cern.ch//eos/user/p/psuryade/ml_ntuples/PU_14_1/step1_${index}.root --filein  file:step1_${index}.root  --fileout file:step2_${index}.root --nThreads 4
