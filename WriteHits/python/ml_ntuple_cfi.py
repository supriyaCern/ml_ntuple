...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/eos/user/p/psuryade/SimOut/DeltaPt/step2_m2.root')
...
process.TFileService = cms.Service("TFileService",
     fileName = cms.string('/eos/user/p/psuryade/SimOut/DeltaPt/ml_ntuple/ml_ntuple_EE2.root')
 )
